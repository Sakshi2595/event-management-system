...
import com.stackroute.eventmanagement.authentication.JwtConfig.SecurityTokenGenerator;
...
import com.stackroute.eventmanagement.authentication.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody UserModel user) throws UserNotFoundException, UserAlreadyExistsException {
